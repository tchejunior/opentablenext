...
export default async function handler(req: NextApiRequest, res: NextApiResponse<Data>) {
  //   await prisma.n13_Table.deleteMany();
  await prisma.n13_Review.deleteMany();
  await prisma.n13_Item.deleteMany();
  await prisma.n13_Restaurant.deleteMany();
  await prisma.n13_Location.deleteMany();
  await prisma.n13_Cuisine.deleteMany();
  await prisma.n13_User.deleteMany();

  await prisma.n13_Location.createMany({
    data: [{ name: 'ottawa' }, { name: 'toronto' }, { name: 'niagara' }],
  });

  await prisma.n13_Cuisine.createMany({
    data: [{ name: 'indian' }, { name: 'italian' }, { name: 'mexican' }],
  });

  const locations = await prisma.n13_Location.findMany();
  const cuisines = await prisma.n13_Cuisine.findMany();
  ...
  await prisma.n13_Restaurant.createMany({
    data: [
      // INDIAN //
      {
  ...
  await prisma.n13_Item.createMany({
    data: [
      {
    ...
    const userLaith = await prisma.n13_User.create({
      data: {
        first_name: "Laith",
        last_name: "Harb",
    ...
    const userJosh = await prisma.n13_User.create({
      data: {
        first_name: "Josh",
        last_name: "Allen",
    ...
    const userLebron = await prisma.n13_User.create({
      data: {
        first_name: "LeBron",
        last_name: "James",
    ...
    const userCassidy = await prisma.n13_User.create({
      data: {
        first_name: "Cassidy",
        last_name: "Marksom",
    ...
    await prisma.n13_Review.createMany({
      data: [
        {
          first_name: "Laith",
          last_name: "Harb",
    ...
    await prisma.n13_Table.createMany({
      data: [
        {
          restaurant_id: vivaanId,
          seats: 4,
